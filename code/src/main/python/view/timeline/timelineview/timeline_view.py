...
class TimelineView(QFrame):
    ...
    def __show_tracks(self):
        ...
        tr1 = TrackView(2000, 50)
        tr1.add_timeable(TimeableView("timeable1", 200, 50, 0))
        tr1.add_timeable(TimeableView("timeable2", 400, 50, 300))
        self.track_frame.add_track(tr1)
        btn1 = QPushButton("Track 1")
        btn1.setFixedSize(80, 50)
        self.track_button_frame.add_button(btn1)

        tr2 = TrackView(2000, 50)
        tr2.add_timeable(TimeableView("timeable3", 200, 50, 150))
        self.track_frame.add_track(tr2)
        btn2 = QPushButton("Track 2")
        btn2.setFixedSize(80, 50)
        self.track_button_frame.add_button(btn2)

        tr3 = TrackView(2000, 50)
        tr3.add_timeable(TimeableView("timeable4", 300, 50, 700))
        self.track_frame.add_track(tr3)
        btn3 = QPushButton("Track 3")
        btn3.setFixedSize(80, 50)
        self.track_button_frame.add_button(btn3)

        tr4 = TrackView(2000, 50)
        tr4.add_timeable(TimeableView("timeable5", 300, 50, 400))
        tr4.add_timeable(TimeableView("timeable6", 100, 50, 0))
        self.track_frame.add_track(tr4)
        btn4 = QPushButton("Track 4")
        btn4.setFixedSize(80, 50)
