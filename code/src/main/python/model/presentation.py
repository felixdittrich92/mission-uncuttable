...
class Presentation:
    ...
    def convert(self, file_path, filename, new_project_path, new_project_name):
        """a method that creates a new project folder takes a pdf-file and split it into pictures which will save in the new folder"""
    ...
    def check_color(self, file_path, filename, left_pixel, upper_pixel, right_pixel, lower_pixel):
        """a method that checks if the place in the picture for video is free"""
